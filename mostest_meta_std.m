...
%% calculate C0_reg from the cohort with biggest sample size

[max_n,index_n]=max(nsubj_cohort);
Files=dir('/home/aihual/meta_29112020/input_pheno/*.txt');
pheno_cohort=strcat(input_pheno_folder,'/',Files(index_n).name);
ymat_cohort=dlmread(pheno_cohort);
...
%suppose all phenotype has variation for all cohorts?
%measures=ymat_cohort.Properties.VariableNames;
